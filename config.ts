...
export const CONFIG = {
  ...
  createDepositTransaction: BASE_URL + "/app/exchange/users/uploadPaymentDetails",
  ...
  deleteWithdrawBank: BASE_URL + "/app/exchange/users/deleteWithdrawalBankDetails",
  userWithdrawBankList: BASE_URL + "/app/exchange/users/getWithdrawalBankDetails",
  calculateWithdrawAmt: BASE_URL + "/app/exchange/users/calculateWithdrawalAmount",
  ...
  getTransferCharges: BASE_URL + "/app/exchange/users/transfer/getTransferCharges",
  ...
  userUnSettleBetListCustomURL: BASE_URL + "/app/exchange/users/betlist/mobile/unSettledBetList",
  ...
  createAutoPaymentOrder: BASE_URL + "/app/exchange/users/deposit/createPaymentOrder",
  ...
  casinoTableList: BASE_URL +"/api/exchange/navigations/casino/casinoTableList",
